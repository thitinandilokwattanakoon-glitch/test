<template>
  <div class="profile-page">
    ...
    <button type="button" class="logout-btn" @click="handleLogout">ออกจากระบบ</button>
...
import { getHealthProfile, updateHealthProfile, logoutUser } from '../lib/api.js'
...
.logout-btn {
  width: 100%; max-width: 560px; margin: 12px auto 0; padding: 14px; display: block;
